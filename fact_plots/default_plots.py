...
'arrTimeShower_variance' : dict(bins=100, range=[0, 5], log=False, func=np.sqrt, xUnit="slice" ),
...
'MCorsikaEvtHeader.fMomentumX': dict(bins=100, range=None, log=False, func=False, xUnit="cm" ),
