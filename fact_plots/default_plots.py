...
default_plots = {
'Alpha' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'Alpha_Off_1' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'Alpha_Off_2' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'Alpha_Off_3' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'Alpha_Off_4' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'Alpha_Off_5' : dict(bins=50, range=[-2, 2], log=True, func=False, xUnit="rad"),
'AzPointing' : False,
'AzSourceCalc' : None,
'AzTracking' : False,
'COGx' : dict(bins=50, range=[-200, 250], log=True, func=False, xUnit="mm"),
'COGy' : dict(bins=50, range=[-200, 250], log=True, func=False, xUnit="mm"),
...
'CosDeltaAlpha_Off_2' : dict(bins=100, range=[-2.0, 2], log=False, func=False, xUnit="a.u."),
...
'Length' : dict(bins=100, range=[0.0, 100.0], log=False, func=False, xUnit="mm" ),
# 'Length' : dict(bins=100, log=True, func=False, xUnit="mm" ),
'M3Long' : dict(bins=500, range=[-1.5, 1.5], log=False, func=False, xUnit="a.u." ),
'M3Trans' : dict(bins=500, range=[-1.5, 1.5], log=False, func=False, xUnit="a.u." ),
'M4Long' : dict(bins=500, range=[0, 5], log=False, func=False, xUnit="a.u." ),
'M4Trans' : dict(bins=500, range=[0, 5], log=False, func=False, xUnit="a.u." ),
'NPIX' : False,
'NROI' : False,
...
'Timespread' : dict(bins=100, range=[-1, 20], log=True, func=lambda x: x*0.5, xUnit="ns" ),
...
'arrivalTimeMean' : dict(bins=100, range=[20, 40], log=False, func=lambda x: x*0.5, xUnit="ns" ),
